...
var LIRPSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Delete selection value on notification").setDesc("If set, the selected value for notification is deleted when used.").addToggle((toggle) => {
    ...
    new import_obsidian.Setting(containerEl).setName("Reference depth limit").setDesc("Reference recursion limit: how many nested reference calls are allowed. Zero prevents reference from being resolved.").addSlider(
