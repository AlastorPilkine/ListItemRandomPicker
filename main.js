...
var ListItemRandomPicker = class extends import_obsidian.Plugin {
  ...
  insertListSetting(stringToInsert) {
    const activeView = this.app.workspace.getActiveViewOfType(import_obsidian.MarkdownView);
    if (activeView) {
